...
public class UserService implements IUserService {
    ...
    public Application createApplication(User user, Application application) {
        ...
        System.out.println("Optional user : " + optionalUser.toString());
        User userInstance = optionalUser.orElse(null);
        System.out.println("User instance : " + userInstance.toString());
        
        if (userInstance != null) {
            userInstance.addApplication(application);
            return application;
        }
        else {
            return null;
